  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] flex flex-col items-center px-6 py-4">
      ...
      <MotionWrapper variant="blurIn">
        ...
        {/* app image */}
        <div className="relative mt-10 overflow-hidden bg-background">
          {/* gradient */}
          ...
          {/* poster image */}
          <div className="relative mx-auto max-w-7xl overflow-hidden rounded-2xl border p-1 shadow-lg dark:shadow-gray-800">
