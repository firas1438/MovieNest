...
const Footer = () => {
  return (
    <footer className="mt-12 xs:mt-20 border-t">
      ...
      <div className="max-w-[90rem] mx-auto px-6 py-12 flex flex-col md:flex-row justify-between gap-x-16 gap-y-10">
        ...
        <div className="md:w-1/12 space-y-4">
          ...
          <ul className="space-y-3">
            <li>
              <Link href="/movies" className="text-sm text-muted-foreground hover:text-foreground transition-colors"> Movies </Link>
            </li>
            <li>
              <Link href="/shows" className="text-sm text-muted-foreground hover:text-foreground transition-colors"> TV Shows </Link>
            </li>
            <li>
              <Link href="/celebrities" className="text-sm text-muted-foreground hover:text-foreground transition-colors"> Celebrities </Link>
            </li>
            <li>
              <Link href="/bookmarks" className="text-sm text-muted-foreground hover:text-foreground transition-colors"> Bookmarks </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="md:w-1/4 space-y-4">
          ...
          <a
            href="mailto:themovienest@gmail.com"
      ...
      {/* bottom bar */}
      <div className="mx-auto px-6 py-8 flex justify-center items-center">
